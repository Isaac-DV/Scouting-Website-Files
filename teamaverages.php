...
echo ' ';
echo '<a href="http://www.gorohi.com/1323/search.php">Search Teams</a>';
/*
$server = 'localhost';
...
while ($data = mysql_fetch_array($average)){
	...
	$matchcount = mysql_query('select teamNumber from matchData where teamNumber = "'.$data['teamNumber'].'"');
